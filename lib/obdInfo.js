...
responsePIDS = [
    ...
    //DOMINAR EXPERIMENTAL
    {mode: modeRealTime, pid: "2120", bytes: 1, name: "domi_exp_20",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
    {mode: modeRealTime, pid: "2121", bytes: 1, name: "domi_exp_21",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
    {mode: modeRealTime, pid: "2122", bytes: 1, name: "domi_exp_22",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
    {mode: modeRealTime, pid: "2123", bytes: 1, name: "domi_exp_23",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
    {mode: modeRealTime, pid: "2124", bytes: 1, name: "domi_exp_24",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
    {mode: modeRealTime, pid: "2125", bytes: 1, name: "domi_exp_25",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},

    {mode: modeRealTime, pid: "010C", bytes: 1, name: "domi_exp_0C",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
    {mode: modeRealTime, pid: "010D", bytes: 1, name: "domi_exp_0D",    description: "Gear Position", min: 0, max: 0, unit: "Bit Encoded", convertToUseful: bitDecoder},
];
