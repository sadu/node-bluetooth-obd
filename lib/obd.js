...
/**
 * Static method to add custom PID configs from runtime.
 * 
 * @param {array} PIDConfigs As found on obdinfo.js
 */
OBDReader.addPIDConfigs = function (PIDConfigs) {
    PIDS = PIDS.concat(PIDConfigs);
};
